...
session_start();
    ...
    {
        $data=$_POST['LL_Description'];
        $fp = fopen('LL_Description.txt', 'a');
        fwrite($fp, $data);
        fclose($fp);
    }
        ...
        <div id="part1" style="display: block;">
            ...
            <div class="form">
                ...
                <form method="post">
                    ...
                    <input type="text" placeholder="Description of problem" name="LL_Description" required>
                    <br>
                    <br>
        ...
        <div id="part4" style="display: none;">
            <div class="form">
                <form>
                    ...
                    <br><br>
                    <input type="button" id="Yes" onclick="window.location.href='Callout.html';" value="Yes" />
